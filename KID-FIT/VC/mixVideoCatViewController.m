...
#import "mixVideoCatViewController.h"
...
@interface mixVideoCatViewController ()
@property(nonatomic,strong)PreMixMusCat *mSelectedCat;
@end

@implementation mixVideoCatViewController
...

{
    ...
    mixVideoPlayListViewController *venueDetail = [storyboard instantiateViewControllerWithIdentifier:@"preVideoMixedCat"];
