...

{
    ...
    fvcell = [tableView dequeueReusableCellWithIdentifier:simpleTableIdentifier];
    if(fvcell == nil){
        fvcell = [tracksTableViewCell tracksTableViewCell];
    }
    
    fvcell.backgroundColor = fvcell.contentView.backgroundColor;
    ...
    fvcell.titleTrack.text = playlisMixobject.AllTrackstitle;
    fvcell.authurName.text =[NSString stringWithFormat:@"by %@",playlisMixobject.AllTracksartistname];
    [fvcell.musicThumbnail setImage:[UIImage imageNamed:@"videoimgmed.jpg"]];
...
////    if(fvcell)
////        return fvcell.frame.size.height;
////    else
...
//     */
//    return UITableViewAutomaticDimension+fvcell.frame.size.height+40 ;
//}
-(void)retrievedata

{
    favvalert = [[UIAlertView alloc] initWithTitle:@"Loading" message:@"Please Wait" delegate:self cancelButtonTitle:nil otherButtonTitles:nil];
    [favvalert show];
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_HIGH, 0), ^{
        ...
        NSString *post =[[NSString alloc] initWithFormat:@"user_id=%@&music_type=2&save=3",savedValue];
            ...
            
        {
            ...
            if(success == 1)
            {
                ...
                dispatch_async(dispatch_get_main_queue(), ^{ // 2
                    [favvalert dismissWithClickedButtonIndex:favvalert.cancelButtonIndex animated:YES];
